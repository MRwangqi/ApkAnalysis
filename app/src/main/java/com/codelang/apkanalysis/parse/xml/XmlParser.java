package com.codelang.apkanalysis.parse.xml;

import static com.codelang.apkanalysis.parse.utils.Reader.log;
...
import com.codelang.apkanalysis.parse.utils.BytesReader;
import com.codelang.apkanalysis.parse.utils.Utils;
import com.codelang.apkanalysis.parse.xml.bean.Attribute;
import com.codelang.apkanalysis.parse.xml.bean.Xml;
import com.codelang.apkanalysis.parse.xml.bean.chunk.Chunk;
import com.codelang.apkanalysis.parse.xml.bean.chunk.EndNameSpaceChunk;
import com.codelang.apkanalysis.parse.xml.bean.chunk.EndTagChunk;
import com.codelang.apkanalysis.parse.xml.bean.chunk.StartNameSpaceChunk;
import com.codelang.apkanalysis.parse.xml.bean.chunk.StartTagChunk;
...
public class XmlParser {
    ...
    private void generateXml(Callback callback) {
        Xml xml = new Xml(stringChunkList, null, chunkList);
        callback.result(xml.toString());
    }
